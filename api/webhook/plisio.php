...
error_log('Plisio Webhook Received: ' . json_encode($log_data));
...
try {
    ...
    // Get Plisio gateway for signature verification
    ...
    error_log('Plisio webhook processed successfully: ' . json_encode($result));
